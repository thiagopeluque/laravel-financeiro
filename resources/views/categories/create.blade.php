                ...
                <div class="p-6">
                    <form method="POST" action="{{ route('categories.store') }}">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="nome" id="nome" value="{{ old('nome') }}" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" placeholder="Ex: Alimentação">
                            @error('nome')
