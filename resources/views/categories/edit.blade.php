                ...
                <div class="p-6">
                    <form method="POST" action="{{ route('categories.update', $category) }}">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="nome" id="nome" value="{{ old('nome', $category->nome) }}" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" placeholder="Ex: Alimentação">
                            @error('nome')
                        ...
                        <div class="mb-4">
                            ...
                            <select name="tipo" id="tipo" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
